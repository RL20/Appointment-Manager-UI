...
var Drawerr = React.createClass({
    ...
    componentDidMount: function() {
        ...
        window.onhashchange = this.onBackButtonEvent;
    },
    onBackButtonEvent: function(e) {
        alert("jhknjlmk;,l.njmkl,");
            e.preventDefault();
        ...
        this.setState({open: !this.state.open});
            ...
            ReactDOM.render(
                ...
                , document.getElementById('app'));
    },_handleStuff: function() {
            alert();
            console.log(this);
    },openAppointmentTableModel: function() {
            ...
            ReactDOM.render(
                ...
                , document.getElementById('app'));
    },openSetAppointmentPage: function() {
            this.setState({open: false});
