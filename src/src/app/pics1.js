            ...
            for (var k=i; k<i+rowLimit; k++){
                ...
                if (this.props.disableLightbox){
                    photoPreviewNodes.push(
                        ...
                        <div key={k} style={style}><Card zDepth={3} style={{paddingBottom:'33px'}}>
                    ...
                    photoPreviewNodes.push(
                        ...
                        <div key={k} style={style}> <Card zDepth={2} style={{paddingBottom:'33px'}}>
        ...
        if (this.props.disableLightbox){
            ...
            return(
                <div id="Gallery" className="clearfix" ref={(c) => this._gallery = c}>
                    ...
                    />{this.state.lightboxIsOpen ?<div style={{
                        zIndex: 99879999,
                        position: 'fixed',
                        bottom: 0,
                        ...
                        maxWidth:'100%',
                        width: 700,
                        marginLeft: height > width ? '0':'-134px',
                        display: 'flex',
