...
module.exports = {
  ...
  module: {
    loaders: [{
    ...
    },
      {
        ...
        test: /\.json$/, loaders: 'json', include: "json-loader" // react-hot is like browser sync and babel loads jsx and es6-7
      },
      {
  ...
  devServer: {
    ...
    host: 'localhost',//'192.168.2.114', // Change to '0.0.0.0' for external facing server example 'localhost'
    historyApiFallback: true
  }
};
